...
export default function HeroLanding() {
  return (
    <div className="grid  w-screen place-content-center -mt-24 text-4xl font-semibold">
        ...
        <span className="pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-blue-500 to-blue-300 bg-clip-text text-center md:text-8xl text-6xl font-semibold leading-none text-transparent dark:from-white  dark:to-blue-500">
          ...
          <div>
            <div className="relative flex h-[500px]  w-screen flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
              <div
                className={cn(
                  "group rounded-full  border -mt-14  bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200  dark:bg-neutral-900 dark:hover:bg-neutral-800 "
                )}
              >
                <div className="">
