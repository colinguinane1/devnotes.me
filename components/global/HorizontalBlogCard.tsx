...
export default function HorizontalBlogCard({ post, author }: BlogCardProps) {
  return (
    <Card
      className="w-full max-w-2xl rounded-xl overflow-hidden shadow-lg transition-all hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] flex"
      key={post.id}
    >
      <Link
