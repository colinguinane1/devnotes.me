...
export default async function blog({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="container flex flex-col items-center justify-center  mx-auto px-4 md:px-6 lg:px-8  lg:py-24">
      <div className="grid grid-cols-1 place-content-center max-w-2xl  gap-8 md:gap-12">
        <div className="relative ">
          ...
          <Image
            ...
            height={450}
            alt="Blog Post Image"
            className="w-full h-52 rounded-lg transition-all group-hover:scale-105"
            style={{ aspectRatio: "800/450", objectFit: "cover" }}
          />
          <div className="flex absolute top-36 w-full p-2 py-6 bg-gradient-to-t from-background to-transparent   items-center justify-between">
          ...
          <h1 className="text-4xl md:text-5xl pt-8 lg:text-6xl font-bold mb-4">
            {blog.title}
          </h1>
